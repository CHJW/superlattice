...
probe = PLP.load(r'C:\Users\oliver\OneDrive - UNSW\code\jackson_superlattice\superlattice\Triple5data\T5unpol\OP_diff-ev\T5unpol.dat')
...
while x < 31:
    ...
    Ftriple5Model[x].material.rho.pmp(20)
    Ftriple5Model[x].material.name = Ftriple5Model[x].name + '_' + str(x)
    x += 1
