...
LNO_lyrs_mag1 = [ Magnetism( rhoM=0, thetaM=90, interface_above=2, name="LNO_3uc_bottom_mag_" + str(i) ) for i in range(1,6) ]
LNO_lyrs_mag2 = [ Magnetism( rhoM=0, thetaM=90, name="LNO_1uc_mag_" + str(i) ) for i in range(1,6) ]
LNO_lyrs_mag3 = [ Magnetism( rhoM=0, thetaM=90, interface_above=2, name="LNO_3uc_top_mag_" + str(i) ) for i in range(1,6) ]
