...
sample = STO( 0, 1.5 ) | LSMO( 
    p[2], p[0], LSMO_mag ) | LNO( 
    p[5], p[3], LNO_mag ) | LSMO( 
    p[7], p[6], LSMO_mag ) | LNO( 
    p[9], p[8], LNO_mag ) | LSMO( 
    p[11], p[10], LSMO_mag ) | LNO( 
    p[13], p[12], LNO_mag ) | LSMO( 
    p[15], p[14], LSMO_mag ) | LNO( 
    p[17], p[16], LNO_mag ) | LSMO(
    p[19], p[18], LSMO_mag ) | LNO(
    p[21], p[20], LNO_mag ) | LSMO(
    p[23], p[22], LSMO_mag ) | LNO(
    p[25], p[24], LNO_mag ) | LSMO(
    p[27], p[26], LSMO_mag ) | LNO(
    p[29], p[28], LNO_mag ) | LSMO(
    p[31], p[30], LSMO_mag ) | LNO(
    p[33], p[32], LNO_mag ) | LSMO(
    p[35], p[34], LSMO_mag ) | LNO(
    p[37], p[36], LNO_mag ) | LSMO(
    p[39], p[38], LSMO_mag ) | LNO(
    p[41], p[40], LNO_mag ) | LSMO(
    p[43], p[42], LSMO_mag ) | LNO(
    p[45], p[44], LNO_mag ) | LSMO(
    p[47], p[46], LSMO_mag ) | LNO(
    p[49], p[48], LNO_mag ) | LSMO(
    p[51], p[50], LSMO_mag ) | LNO(
    p[53], p[52], LNO_mag ) | LSMO(
    p[55], p[54], LSMO_mag ) | LNO(
    p[57], p[56], LNO_mag ) | LSMO(
    p[59], p[58], LSMO_mag ) | LNO(
    p[61], p[60], LNO_mag ) | air
...
for layer in sample:
    ...
    if(layer.name == "LNO"):
        for p in layer.rhoM:
            p.range(0,1)
'''
for p in LSMO_mag.rhoM:
    p.range(1,5)

for p in LNO_mag.rhoM:
    p.range(0,1)
