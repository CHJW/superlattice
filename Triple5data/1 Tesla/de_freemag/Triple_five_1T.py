...
LSMO_lyrs_mag = [ FreeMagnetism( z=np.linspace(0,1,5), rhoM=np.full(5,1), thetaM=np.full(5,90), name="LSMO_mag_" + str(i) ) for i in range(1,16)]
LNO_lyrs_mag1 = [ FreeMagnetism( z=np.linspace(0,1,3), rhoM=np.full(3,0), thetaM=np.full(3,90), name="LNO_3uc_bottom_mag_" + str(i) ) for i in range(1,6) ]
LNO_lyrs_mag2 = [ Magnetism( rhoM=0, thetaM=90, name="LNO_1uc_mag_" + str(i) ) for i in range(1,6) ]
LNO_lyrs_mag3 = [ FreeMagnetism( z=np.linspace(0,1,3), rhoM=np.full(3,0), thetaM=np.full(3,90), name="LNO_3uc_top_mag_" + str(i) ) for i in range(1,6) ]
