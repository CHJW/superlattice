...
Fitting strategy: Load structural SLD from previous fit, and vary the following:

- LSMO rhoM
- LSMO dead layer above
- LSMO dead layer below
- LNO rhoM
...
LSMO_lyrs_mag = [ Magnetism( rhoM=1, thetaM=90, dead_above=0, dead_below=0, name="LSMO_mag_" + str(i) ) for i in range(1,16)]
...
for magl in LSMO_lyrs_mag:
    magl.rhoM.range(0,4)
    magl.dead_above.range(0,5)
    magl.dead_below.range(0,5)
