...
STO = Material(name = 'SrTiO3', density=5.11)

#Model
Fifthteen = (STO (0, 1.5) 
                | LSMO (35.9, 2, magnetism=Magnetism(rhoM=1.3, thetaM=270)) | LNO(11.5, 1, magnetism = MagnetismTwist(rhoM=[0.3, 0.3], thetaM=[270, 270])) 
                | LSMO (35.9, 2, magnetism=Magnetism(rhoM=1.3, thetaM=270)) | LNO(11.5, 1, magnetism = MagnetismTwist(rhoM=[0.3, 0.3], thetaM=[270, 270])) 
                | LSMO (35.9, 2, magnetism=Magnetism(rhoM=1.3, thetaM=270)) | LNO(11.5, 1, magnetism = MagnetismTwist(rhoM=[0.3, 0.3], thetaM=[270, 270])) 
                | LSMO (35.9, 2, magnetism=Magnetism(rhoM=1.3, thetaM=270)) | LNO(11.5, 1, magnetism = MagnetismTwist(rhoM=[0.3, 0.3], thetaM=[270, 270])) 
                | LSMO (35.9, 2, magnetism=Magnetism(rhoM=1.3, thetaM=270)) | LNO(11.5, 1, magnetism = MagnetismTwist(rhoM=[0.3, 0.3], thetaM=[270, 270])) 
